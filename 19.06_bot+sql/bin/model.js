...
export class Database {
    ...
    async addUser(telegram_id, chat_id, name = '', telegram_url = '') {
        ...
        try {
            await this.db.run(query, name, telegram_id, chat_id, telegram_url);
        } catch {
    ...
    async test() {
        await this.addUser(22, 25, "Nikita");
        await this.addUser(25, 22, "Egor");
        await this.addEvent("Party", "Almaty", "25-06-2022", 12, 0, "Abay st.");
        await this.addEvent(
            "Disco",
            "Almaty",
            "01-07-2023",
            ...
            0,
            "Altynsarin st.",
            "https://cdn2.vectorstock.com/i/1000x1000/91/31/disco-poster-background-vector-1849131.jpg",
            "18:00",
            "5000"
        );
